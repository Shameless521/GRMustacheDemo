...
- (void)parmerTitleAttribute{
    ...
    [_titleAttribute addAttributes:@{NSFontAttributeName:[UIFont systemFontOfSize:15.0],NSForegroundColorAttributeName:UIColorFromRGB(0x111111)} range:NSMakeRange(0, _titleAttribute.length)];
}
...
- (void)parmerInfoAttribute{
    if (!_infoAttribute) {
        ...
        [_infoAttribute appendAttributedString:[[NSAttributedString alloc] initWithString:[NSString stringWithFormat:@" %ld   ", (long)_watches_count]]];
        ...
        [_infoAttribute appendAttributedString:[[NSAttributedString alloc] initWithString:[NSString stringWithFormat:@" %ld   ", (long)_stars_count]]];
        ...
        [_infoAttribute appendAttributedString:[[NSAttributedString alloc] initWithString:[NSString stringWithFormat:@" %ld", (long)_forks_count]]];
        
        [_infoAttribute addAttributes:@{NSFontAttributeName:[UIFont systemFontOfSize:10],NSForegroundColorAttributeName:UIColorFromRGB(0x9D9D9D)} range:NSMakeRange(0, _infoAttribute.length)];
    }
}
